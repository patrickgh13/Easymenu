...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Logo Selection', 'your-textdomain-here' ),
		'id'    => 'logo',
		'icon'  => 'el el-brush',
	)
);

require_once (dirname(__FILE__) . '/sections/logo/logo.php');
...
require_once (dirname(__FILE__) . '/sections/color-selection/color.php');
